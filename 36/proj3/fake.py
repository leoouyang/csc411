...
def part2(m, p):
    ...
    print("Best Value for m, p is:" + str((m, p)))
...
def decisiontree(max_depth, x, y):
    dt = DecisionTreeClassifier(criterion="gini", splitter="random", max_depth=max_depth, min_samples_split=10, max_features=0.1, random_state=0)
...
def part8():
    print("========================== Part 8 ==========================")
    print("I(Y|'korea'):", IY_x("korea"))
    print("I(Y|'wall'):", IY_x("wall"))
    # result = {}
    # for key in Count:
    #     result[key] = IY_x(key)
    # result2 = []
